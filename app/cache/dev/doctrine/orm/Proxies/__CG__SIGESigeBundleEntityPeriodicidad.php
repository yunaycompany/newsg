...
namespace Proxies\__CG__\SIGE\SigeBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Periodicidad extends \SIGE\SigeBundle\Entity\Periodicidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SIGE\\SigeBundle\\Entity\\Periodicidad' . "\0" . 'id', '' . "\0" . 'SIGE\\SigeBundle\\Entity\\Periodicidad' . "\0" . 'nombredescriptivo', '' . "\0" . 'SIGE\\SigeBundle\\Entity\\Periodicidad' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Periodicidad $proxy) {
