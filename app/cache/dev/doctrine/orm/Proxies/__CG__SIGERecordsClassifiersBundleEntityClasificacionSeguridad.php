 ...
 */
class ClasificacionSeguridad extends \SIGE\RecordsClassifiersBundle\Entity\ClasificacionSeguridad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SIGE\\RecordsClassifiersBundle\\Entity\\ClasificacionSeguridad' . "\0" . 'id', '' . "\0" . 'SIGE\\RecordsClassifiersBundle\\Entity\\ClasificacionSeguridad' . "\0" . 'nombredescriptivo', '' . "\0" . 'SIGE\\RecordsClassifiersBundle\\Entity\\ClasificacionSeguridad' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ClasificacionSeguridad $proxy) {
