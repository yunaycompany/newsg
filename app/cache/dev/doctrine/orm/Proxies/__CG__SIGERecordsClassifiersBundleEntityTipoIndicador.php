 ...
 */
class TipoIndicador extends \SIGE\RecordsClassifiersBundle\Entity\TipoIndicador implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SIGE\\RecordsClassifiersBundle\\Entity\\TipoIndicador' . "\0" . 'id', '' . "\0" . 'SIGE\\RecordsClassifiersBundle\\Entity\\TipoIndicador' . "\0" . 'nombredescriptivo', '' . "\0" . 'SIGE\\RecordsClassifiersBundle\\Entity\\TipoIndicador' . "\0" . 'descripcion');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoIndicador $proxy) {
