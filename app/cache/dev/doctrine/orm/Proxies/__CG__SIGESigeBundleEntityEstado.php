 ...
 */
class Estado extends \SIGE\SigeBundle\Entity\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'SIGE\\SigeBundle\\Entity\\Estado' . "\0" . 'id', '' . "\0" . 'SIGE\\SigeBundle\\Entity\\Estado' . "\0" . 'nombredescriptivo', '' . "\0" . 'SIGE\\SigeBundle\\Entity\\Estado' . "\0" . 'encuestas');
        }
