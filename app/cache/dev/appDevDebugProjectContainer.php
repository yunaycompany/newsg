...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'excepciones.twig.parameter_admin_expose_extension' => 'getExcepciones_Twig_ParameterAdminExposeExtensionService',
            'exception' => 'getExceptionService',
            ...
            'kernel.excepciones.listener' => 'getKernel_Excepciones_ListenerService',
            'locale_listener' => 'getLocaleListenerService',
            'localexception' => 'getLocalexceptionService',
            ...
            'sige.class.handler' => 'getSige_Class_HandlerService',
            'sige.security.logout_success_handler' => 'getSige_Security_LogoutSuccessHandlerService',
            ...
            'uci.boson.cache' => 'getUci_Boson_CacheService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.exception', array(0 => 'kernel.excepciones.listener', 1 => 'onKernelException'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'sige4', 'user' => 'postgres', 'password' => 1, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/SIGE/SigeBundle/Entity'), 1 => ($this->targetDirs[3].'/src/SIGE/DataEntryBundle/Entity'), 2 => ($this->targetDirs[3].'/src/SIGE/ModelGeneratorBundle/Entity'), 3 => ($this->targetDirs[3].'/src/SIGE/RecordsClassifiersBundle/Entity'), 4 => ($this->targetDirs[3].'/src/SIGE/SecurityManagerBundle/Entity'), 5 => ($this->targetDirs[3].'/src/SIGE/DisciplineBundle/Entity'), 6 => ($this->targetDirs[3].'/src/SIGE/ToolsBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'SIGE\\SigeBundle\\Entity');
        $c->addDriver($b, 'SIGE\\DataEntryBundle\\Entity');
        $c->addDriver($b, 'SIGE\\ModelGeneratorBundle\\Entity');
        $c->addDriver($b, 'SIGE\\RecordsClassifiersBundle\\Entity');
        $c->addDriver($b, 'SIGE\\SecurityManagerBundle\\Entity');
        $c->addDriver($b, 'SIGE\\DisciplineBundle\\Entity');
        $c->addDriver($b, 'SIGE\\ToolsBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('SigeBundle' => 'SIGE\\SigeBundle\\Entity', 'DataEntryBundle' => 'SIGE\\DataEntryBundle\\Entity', 'ModelGeneratorBundle' => 'SIGE\\ModelGeneratorBundle\\Entity', 'RecordsClassifiersBundle' => 'SIGE\\RecordsClassifiersBundle\\Entity', 'SecurityManagerBundle' => 'SIGE\\SecurityManagerBundle\\Entity', 'DisciplineBundle' => 'SIGE\\DisciplineBundle\\Entity', 'ToolsBundle' => 'SIGE\\ToolsBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_db3def79c54e08fb45764efa40bd433585fb46c42cd960b60996925c7540e008');
    ...
    {
        return $this->services['escape_wsse_authentication.entry_point.wsse_secured'] = new \Escape\WSSEAuthenticationBundle\Security\Http\EntryPoint\EntryPoint($this->get('logger'), NULL, 'UsernameToken');
    }
    ...
    {
        return $this->services['escape_wsse_authentication.listener.wsse_secured'] = new \Escape\WSSEAuthenticationBundle\Security\Http\Firewall\Listener($this->get('security.token_storage'), $this->get('security.authentication.manager'), 'wsse_secured', $this->get('escape_wsse_authentication.entry_point.wsse_secured'));
    }
    ...
    {
        return $this->services['escape_wsse_authentication.provider'] = new \Escape\WSSEAuthenticationBundle\Security\Core\Authentication\Provider\Provider($this->get('translator'), $this->get('doctrine.orm.default_entity_manager'), $this->get('security.user_checker.wsse_secured'), NULL, NULL, NULL, NULL, 300, '/^([\\+-]?\\d{4}(?!\\d{2}\\b))((-?)((0[1-9]|1[0-2])(\\3([12]\\d|0[1-9]|3[01]))?|W([0-4]\\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\\d|[12]\\d{2}|3([0-5]\\d|6[1-6])))([T\\s]((([01]\\d|2[0-3])((:?)[0-5]\\d)?|24\\:?00)([\\.,]\\d+(?!:))?)?(\\17[0-5]\\d([\\.,]\\d+)?)?([zZ]|([\\+-])([01]\\d|2[0-3]):?([0-5]\\d)?)?)?)?$/');
    }
    ...
    {
        return $this->services['escape_wsse_authentication.provider.wsse_secured'] = new \Escape\WSSEAuthenticationBundle\Security\Core\Authentication\Provider\Provider($this->get('translator'), $this->get('doctrine.orm.default_entity_manager'), $this->get('security.user_checker.wsse_secured'), new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'SecurityManagerBundle:Usuario', 'username', NULL), 'wsse_secured', $this->get('escape_wsse_authentication.encoder.wsse_secured'), $this->get('escape_wsse_authentication.nonce_cache.wsse_secured'), 1800, '/^([\\+-]?\\d{4}(?!\\d{2}\\b))((-?)((0[1-9]|1[0-2])(\\3([12]\\d|0[1-9]|3[01]))?|W([0-4]\\d|5[0-2])(-?[1-7])?|(00[1-9]|0[1-9]\\d|[12]\\d{2}|3([0-5]\\d|6[1-6])))([T\\s]((([01]\\d|2[0-3])((:?)[0-5]\\d)?|24\\:?00)([\\.,]\\d+(?!:))?)?(\\17[0-5]\\d([\\.,]\\d+)?)?([zZ]|([\\+-])([01]\\d|2[0-3]):?([0-5]\\d)?)?)?)?$/');
    }

    /**
     * Gets the 'excepciones.twig.parameter_admin_expose_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UCI\Boson\ExcepcionesBundle\Twig\ParameterAdminExposeExtension A UCI\Boson\ExcepcionesBundle\Twig\ParameterAdminExposeExtension instance.
     */
    protected function getExcepciones_Twig_ParameterAdminExposeExtensionService()
    {
        return $this->services['excepciones.twig.parameter_admin_expose_extension'] = new \UCI\Boson\ExcepcionesBundle\Twig\ParameterAdminExposeExtension(array('email_admin_contact' => 'boson@uci.cu'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UCI\Boson\ExcepcionesBundle\Exception\Excepcion A UCI\Boson\ExcepcionesBundle\Exception\Excepcion instance.
     */
    protected function getExceptionService()
    {
        return $this->services['exception'] = new \UCI\Boson\ExcepcionesBundle\Exception\Excepcion($this);
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'/src/AppBundle/Resources/config/serializer'), 'SIGE\\SigeBundle' => ($this->targetDirs[3].'/src/SIGE/SigeBundle/Resources/config/serializer'), 'SIGE\\AdminBundle' => ($this->targetDirs[3].'/src/SIGE/AdminBundle/Resources/config/serializer'), 'SIGE\\DataEntryBundle' => ($this->targetDirs[3].'/src/SIGE/DataEntryBundle/Resources/config/serializer'), 'SIGE\\ModelGeneratorBundle' => ($this->targetDirs[3].'/src/SIGE/ModelGeneratorBundle/Resources/config/serializer'), 'SIGE\\RecordsClassifiersBundle' => ($this->targetDirs[3].'/src/SIGE/RecordsClassifiersBundle/Resources/config/serializer'), 'SIGE\\SecurityManagerBundle' => ($this->targetDirs[3].'/src/SIGE/SecurityManagerBundle/Resources/config/serializer'), 'SIGE\\DisciplineBundle' => ($this->targetDirs[3].'/src/SIGE/DisciplineBundle/Resources/config/serializer'), 'SIGE\\ToolsBundle' => ($this->targetDirs[3].'/src/SIGE/ToolsBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'Nelmio\\ApiDocBundle' => ($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/config/serializer'), 'UCI\\Boson\\ExcepcionesBundle' => ($this->targetDirs[3].'/vendor/boson/excepciones-bundle/UCI/Boson/ExcepcionesBundle/Resources/config/serializer'), 'Liuggio\\ExcelBundle' => ($this->targetDirs[3].'/vendor/liuggio/ExcelBundle/Resources/config/serializer'), 'Escape\\WSSEAuthenticationBundle' => ($this->targetDirs[3].'/vendor/escapestudios/wsse-authentication-bundle/Escape/WSSEAuthenticationBundle/Resources/config/serializer'), 'UCI\\Boson\\CacheBundle' => ($this->targetDirs[3].'/vendor/boson/cache-bundle/UCI/Boson/CacheBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\FixturesBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-fixtures-bundle/Resources/config/serializer')));
    ...
    /**
     * Gets the 'kernel.excepciones.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UCI\Boson\ExcepcionesBundle\EventListener\ExceptionListener A UCI\Boson\ExcepcionesBundle\EventListener\ExceptionListener instance.
     */
    protected function getKernel_Excepciones_ListenerService()
    {
        return $this->services['kernel.excepciones.listener'] = new \UCI\Boson\ExcepcionesBundle\EventListener\ExceptionListener($this, ($this->targetDirs[2].'/logs/'));
    }
    ...
    /**
     * Gets the 'localexception' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UCI\Boson\ExcepcionesBundle\Exception\Excepcion A UCI\Boson\ExcepcionesBundle\Exception\Excepcion instance.
     */
    protected function getLocalexceptionService()
    {
        return $this->services['localexception'] = new \UCI\Boson\ExcepcionesBundle\Exception\Excepcion($this);
    }
    ...
    protected function getNelmioApiDoc_Formatter_HtmlFormatterService()
    {
        ...
        $instance->setApiName('Documentación SIGE');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('SIGE\\SecurityManagerBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha1', 1 => true, 2 => 5000))));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.wsse_secured' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_WsseSecuredService()
    {
        ...
        $e = new \Symfony\Component\Security\Http\HttpUtils($b, $b);

        return $this->services['security.firewall.map.context.wsse_secured'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($d, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\LogoutListener($c, $e, $this->get('sige.security.logout_success_handler'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => NULL)), 2 => $this->get('escape_wsse_authentication.listener.wsse_secured'), 3 => new \Symfony\Component\Security\Http\Firewall\AccessListener($c, $this->get('security.access.decision_manager'), $d, $this->get('security.authentication.manager'))), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($c, $this->get('security.authentication.trust_resolver'), $e, 'wsse_secured', $this->get('escape_wsse_authentication.entry_point.wsse_secured'), NULL, NULL, $a, true));
    }
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 0, 'cookie_httponly' => true, 'gc_probability' => 1), NULL, $this->get('session.storage.metadata_bag'));
    }
    ...
    /**
     * Gets the 'sige.class.handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SIGE\SigeBundle\HandlerRest\ClassHandler A SIGE\SigeBundle\HandlerRest\ClassHandler instance.
     */
    protected function getSige_Class_HandlerService()
    {
        return $this->services['sige.class.handler'] = new \SIGE\SigeBundle\HandlerRest\ClassHandler($this->get('security.context'), $this->get('translator'), $this->get('doctrine.orm.default_entity_manager'), $this->get('form.factory'), $this->get('uci.boson.cache'), $this->get('jms_serializer'));
    }

    /**
     * Gets the 'sige.security.logout_success_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \SIGE\SigeBundle\Handler\LogoutSuccessHandler A SIGE\SigeBundle\Handler\LogoutSuccessHandler instance.
     */
    protected function getSige_Security_LogoutSuccessHandlerService()
    {
        return $this->services['sige.security.logout_success_handler'] = new \SIGE\SigeBundle\Handler\LogoutSuccessHandler($this->get('security.token_storage'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.bg.xlf')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.he.xlf')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.az.xlf')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/boson/cache-bundle/UCI/Boson/CacheBundle/Resources/translations/messages.fr.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.zh_CN.xlf')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hr.xlf')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.no.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/src/SIGE/SigeBundle/Resources/translations/translatesexcepciones.es.yml'), 4 => ($this->targetDirs[3].'/src/SIGE/SigeBundle/Resources/translations/messages.es.yml'), 5 => ($this->targetDirs[3].'/src/SIGE/AdminBundle/Resources/translations/translatesexcepciones.es.yml'), 6 => ($this->targetDirs[3].'/src/SIGE/DataEntryBundle/Resources/translations/translatesexcepciones.es.yml'), 7 => ($this->targetDirs[3].'/src/SIGE/ModelGeneratorBundle/Resources/translations/translatesexcepciones.es.yml'), 8 => ($this->targetDirs[3].'/src/SIGE/RecordsClassifiersBundle/Resources/translations/translatesexcepciones.es.yml'), 9 => ($this->targetDirs[3].'/src/SIGE/RecordsClassifiersBundle/Resources/translations/messages.es.yml'), 10 => ($this->targetDirs[3].'/src/SIGE/SecurityManagerBundle/Resources/translations/translatesexcepciones.es.yml'), 11 => ($this->targetDirs[3].'/src/SIGE/SecurityManagerBundle/Resources/translations/messages.es.yml'), 12 => ($this->targetDirs[3].'/src/SIGE/DisciplineBundle/Resources/translations/translatesexcepciones.es.yml'), 13 => ($this->targetDirs[3].'/src/SIGE/ToolsBundle/Resources/translations/translatesexcepciones.es.yml'), 14 => ($this->targetDirs[3].'/vendor/boson/excepciones-bundle/UCI/Boson/ExcepcionesBundle/Resources/translations/translatesexcepciones.es.yml'), 15 => ($this->targetDirs[3].'/vendor/boson/excepciones-bundle/UCI/Boson/ExcepcionesBundle/Resources/translations/messages.es.yml'), 16 => ($this->targetDirs[3].'/vendor/escapestudios/wsse-authentication-bundle/Escape/WSSEAuthenticationBundle/Resources/translations/messages.es.yml'), 17 => ($this->targetDirs[3].'/vendor/boson/cache-bundle/UCI/Boson/CacheBundle/Resources/translations/translatesexcepciones.es.yml'), 18 => ($this->targetDirs[3].'/vendor/boson/cache-bundle/UCI/Boson/CacheBundle/Resources/translations/messages.es.yml')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.th.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ja.xlf')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lt.xlf')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/src/SIGE/SigeBundle/Resources/translations/translatesexcepciones.en.yml'), 4 => ($this->targetDirs[3].'/src/SIGE/SigeBundle/Resources/translations/messages.en.yml'), 5 => ($this->targetDirs[3].'/src/SIGE/AdminBundle/Resources/translations/translatesexcepciones.en.yml'), 6 => ($this->targetDirs[3].'/src/SIGE/DataEntryBundle/Resources/translations/translatesexcepciones.en.yml'), 7 => ($this->targetDirs[3].'/src/SIGE/ModelGeneratorBundle/Resources/translations/translatesexcepciones.en.yml'), 8 => ($this->targetDirs[3].'/src/SIGE/RecordsClassifiersBundle/Resources/translations/translatesexcepciones.en.yml'), 9 => ($this->targetDirs[3].'/src/SIGE/RecordsClassifiersBundle/Resources/translations/messages.en.yml'), 10 => ($this->targetDirs[3].'/src/SIGE/SecurityManagerBundle/Resources/translations/translatesexcepciones.en.yml'), 11 => ($this->targetDirs[3].'/src/SIGE/SecurityManagerBundle/Resources/translations/messages.en.yml'), 12 => ($this->targetDirs[3].'/src/SIGE/DisciplineBundle/Resources/translations/translatesexcepciones.en.yml'), 13 => ($this->targetDirs[3].'/src/SIGE/ToolsBundle/Resources/translations/translatesexcepciones.en.yml'), 14 => ($this->targetDirs[3].'/vendor/boson/excepciones-bundle/UCI/Boson/ExcepcionesBundle/Resources/translations/translatesexcepciones.en.yml'), 15 => ($this->targetDirs[3].'/vendor/boson/excepciones-bundle/UCI/Boson/ExcepcionesBundle/Resources/translations/messages.en.yml'), 16 => ($this->targetDirs[3].'/vendor/escapestudios/wsse-authentication-bundle/Escape/WSSEAuthenticationBundle/Resources/translations/messages.en.yml'), 17 => ($this->targetDirs[3].'/vendor/boson/cache-bundle/UCI/Boson/CacheBundle/Resources/translations/translatesexcepciones.en.yml'), 18 => ($this->targetDirs[3].'/vendor/boson/cache-bundle/UCI/Boson/CacheBundle/Resources/translations/messages.en.yml')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.vi.xlf')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.id.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf')), 'nn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nn.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('excepciones.twig.parameter_admin_expose_extension'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \UCI\Boson\ExcepcionesBundle\Controller\ExceptionController A UCI\Boson\ExcepcionesBundle\Controller\ExceptionController instance.
     */
    protected function getTwig_Controller_ExceptionService()
    {
        return $this->services['twig.controller.exception'] = new \UCI\Boson\ExcepcionesBundle\Controller\ExceptionController($this->get('twig'), true);
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SIGE/SigeBundle/Resources/views'), 'Sige');
        $instance->addPath(($this->targetDirs[3].'/src/SIGE/AdminBundle/Resources/views'), 'Admin');
        $instance->addPath(($this->targetDirs[3].'/src/SIGE/DataEntryBundle/Resources/views'), 'DataEntry');
        $instance->addPath(($this->targetDirs[3].'/src/SIGE/ModelGeneratorBundle/Resources/views'), 'ModelGenerator');
        $instance->addPath(($this->targetDirs[3].'/src/SIGE/RecordsClassifiersBundle/Resources/views'), 'RecordsClassifiers');
        $instance->addPath(($this->targetDirs[3].'/src/SIGE/SecurityManagerBundle/Resources/views'), 'SecurityManager');
        $instance->addPath(($this->targetDirs[3].'/src/SIGE/DisciplineBundle/Resources/views'), 'Discipline');
        $instance->addPath(($this->targetDirs[3].'/src/SIGE/ToolsBundle/Resources/views'), 'Tools');
        $instance->addPath(($this->targetDirs[3].'/vendor/nelmio/api-doc-bundle/Nelmio/ApiDocBundle/Resources/views'), 'NelmioApiDoc');
        $instance->addPath(($this->targetDirs[3].'/vendor/boson/excepciones-bundle/UCI/Boson/ExcepcionesBundle/Resources/views'), 'Excepciones');
        $instance->addPath(($this->targetDirs[3].'/vendor/boson/cache-bundle/UCI/Boson/CacheBundle/Resources/views'), 'Cache');
    ...
    /**
     * Gets the 'uci.boson.cache' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UCI\Boson\CacheBundle\Cache\Cache A UCI\Boson\CacheBundle\Cache\Cache instance.
     */
    protected function getUci_Boson_CacheService()
    {
        return $this->services['uci.boson.cache'] = new \UCI\Boson\CacheBundle\Cache\Cache(array('type' => 'memcache_cache', 'host' => 'localhost', 'port' => 11211));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => $this->get('escape_wsse_authentication.provider.wsse_secured')), true);
    ...
    protected function getSecurity_LogoutUrlGeneratorService()
    {
        ...
        $instance->registerListener('wsse_secured', NULL, 'logout', '_csrf_token', NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SigeBundle' => 'SIGE\\SigeBundle\\SigeBundle',
                'AdminBundle' => 'SIGE\\AdminBundle\\AdminBundle',
                'DataEntryBundle' => 'SIGE\\DataEntryBundle\\DataEntryBundle',
                'ModelGeneratorBundle' => 'SIGE\\ModelGeneratorBundle\\ModelGeneratorBundle',
                'RecordsClassifiersBundle' => 'SIGE\\RecordsClassifiersBundle\\RecordsClassifiersBundle',
                'SecurityManagerBundle' => 'SIGE\\SecurityManagerBundle\\SecurityManagerBundle',
                'DisciplineBundle' => 'SIGE\\DisciplineBundle\\DisciplineBundle',
                'ToolsBundle' => 'SIGE\\ToolsBundle\\ToolsBundle',
                'FOSRestBundle' => 'FOS\\RestBundle\\FOSRestBundle',
                'JMSSerializerBundle' => 'JMS\\SerializerBundle\\JMSSerializerBundle',
                'NelmioApiDocBundle' => 'Nelmio\\ApiDocBundle\\NelmioApiDocBundle',
                'ExcepcionesBundle' => 'UCI\\Boson\\ExcepcionesBundle\\ExcepcionesBundle',
                ...
                'CacheBundle' => 'UCI\\Boson\\CacheBundle\\CacheBundle',
            ...
            'excepciones' => array(
                'email_admin_contact' => 'boson@uci.cu',
            ),
            ...
            'excp_sige_bundle' => array(
                'excepciones' => array(
                    'S1' => array(
                        'mensaje' => 'excepciones.S1.mensaje',
                        'descripcion' => 'Se lanza la excepción cuando los parámetros enviados son incorrectos',
                    ),
                    'S2' => array(
                        'mensaje' => 'excepciones.S2.mensaje',
                        'descripcion' => 'Se lanza la excepción cuando el formato es incorrecto',
                    ),
                    'S3' => array(
                        'mensaje' => 'excepciones.S3.mensaje',
                        'descripcion' => 'Se lanza la excepción cuando no existe el recurso a eliminar',
                    ),
                    'S4' => array(
                        'mensaje' => 'excepciones.S4.mensaje',
                        'descripcion' => 'Se lanza la excepción cuando el usuario no posee permisos para acceder al recurso',
                    ),
                ),
            ),
            'excp_admin_bundle' => array(
                'excepciones' => array(
                    'E626' => array(
                        'mensaje' => 'excepciones.E626.mensaje',
                        'descripcion' => 'este es la descripción',
                    ),
                ),
            ),
            'excp_data_entry_bundle' => array(
                'excepciones' => array(
                    'E626' => array(
                        'mensaje' => 'excepciones.E626.mensaje',
                        'descripcion' => 'este es la descripción',
            ...
            'excp_model_generator_bundle' => array(
                'excepciones' => array(
                    'E626' => array(
                        'mensaje' => 'excepciones.E626.mensaje',
                        'descripcion' => 'este es la descripción',
            ...
            'excp_records_classifiers_bundle' => array(
                'excepciones' => array(
                    'E626' => array(
                        'mensaje' => 'excepciones.E626.mensaje',
                        'descripcion' => 'este es la descripción',
            ...
            'excp_security_manager_bundle' => array(
                'excepciones' => array(
                    'E626' => array(
                        'mensaje' => 'excepciones.E626.mensaje',
                        'descripcion' => 'este es la descripción',
            ...
            'nelmio_api_doc.api_name' => 'Documentación SIGE',
            ...
            'excp_excepciones_bundle' => array(
                'excepciones' => array(
                    'E605' => array(
                        'mensaje' => 'excepciones.E605.mensaje',
                        'descripcion' => 'Ocurrió un error interno del sistema. Por favor contacte
            al administrador E605.',
                    ),
                    'NODEFINED' => array(
                        'mensaje' => 'Excepción disparada por el sistema y no definida en la
                configuración de Excepciónes del sistema. Por favor
                pónganse en contacto con el equipo de desarrollo.',
                        'descripcion' => 'Ocurrió un error interno del sistema. Por favor contacte
                al administrador.',
                        'show_in_prod' => true,
                    ),
            ...
            'cache.boson.class' => 'UCI\\Boson\\CacheBundle\\Cache\\Cache',
